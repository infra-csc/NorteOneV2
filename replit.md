...
- **Kit Config (Mapeamento de Kits):** Admin page (`/admin/kit-config`) for configuring kit multipliers. Fetches kit data from Magento MySQL, stores multipliers in PostgreSQL `kit_config` table. Ticket final = ticket_base × multiplicador. Seed: bundle 50999 (mult 2), 54863 (mult 5).

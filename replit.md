...
- **Kit Config (Mapeamento de Kits):** Admin page (`/admin/kit-config`) for configuring kit multipliers and marking a "Kit Básico" per event, fetching kit data from Magento MySQL and allowing overrides via PostgreSQL.
